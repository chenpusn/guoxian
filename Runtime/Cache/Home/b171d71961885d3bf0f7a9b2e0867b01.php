                ...
                <form class="login-form" action="/index.php?s=/Home/User/login/from/1.html" method="post">
                    <div class="form_body">
                        ...
                        <div class="input_panel">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" id="inputEmail" class="span3" placeholder="请输入用户名"
                                           ajaxurl="/user/checkUserNameUnique.html" errormsg="请填写1-16位用户名"
                                           nullmsg="请填写用户名" datatype="*1-16" value="" name="username">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="password" id="inputPassword" class="span3" placeholder="请输入密码"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" id="verify" class="span3" placeholder="请输入验证码"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <a style="width:280px;" class="btn border-btn-main btn-large"
                                   href="<?php echo U('User/register');?>">立 即 注 册</a>
                            </div>
                            <?php } ?>
                        </div>
                    </div>
