...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
            <div class="table-bar">
                ...
                <form class="muti_search cf" style="text-align: right " method="post"
                      action="<?php echo addons_url('Shop://Order/orderSheet');?>">
                    <div class="" style="line-height: 30px;">
                        <span>订单日期</span>
                        <input type="datetime" name="date"
                               class="search-input date input-small" value="<?php echo ($filter_date); ?>"
            ...
            <div class="data-table" id="printSheetZone">
                <div class="table-striped" style="text-align: center;">
                    <p style="font-weight: bold; font-size: 18px;">好之鲜水果超市<?php echo ($filter_date); ?>日配货单</p>
                    <table cellspacing="1" style="width: 30rem; margin: 2rem auto">
                        <!-- 表头 -->
                        <thead>
                        <tr>
                            <?php if(is_array($title_lists)): $i = 0; $__LIST__ = $title_lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$field): $mod = ($i % 2 );++$i;?><th style="font-weight: bold; text-align: center"><?php echo ($field); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
                        </tr>
                        </thead>

                        <!-- 列表 -->
                        <tbody>
                        <?php if(is_array($goods_lists)): $i = 0; $__LIST__ = $goods_lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goodsData): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($goodsData['title']); ?></td>
                                <td><?php echo ($goodsData['num']); ?></td>
                                <td><?php echo (getSpecUnitByID($goodsData['unit'])); ?></td>
...
(function(){
    ...
    <script type="text/javascript" src="/Public/static/jquery.PrintArea.js"></script>
