...
public class SmsClientSend {
	 ...
	 * 
	 * @param url
	 *            ：必填--发送连接地址URL--比如>http://xtx.telhk.cn:8080/sms.aspx
	 * @param userid
	 *            ：必填--用户ID，为数字
	 * @param account
	 *            ：必填--用户帐号
	 ...
	 */
	public static String sendSms(String url,String action,String userid, String timestamp,
			String sign, String mobile, String content) {

		return sendSms(url,action,userid,timestamp,sign, mobile, content,"",
				 "POST", "UTF-8", "UTF-8");
	}
	 ...
	 * @return 返回发送之后收到的信息
	 */
	private static String sendSms(String url, String action, String userid, String timestamp,
			String sign, String mobile, String content,
			String sendTime,String sendType, String codingType, String backEncodType) {
		...
		try {
			...
			send.append("&timestamp=").append(timestamp);
			send.append("&sign=").append(sign);
